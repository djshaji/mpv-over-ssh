...
import org.acoustixaudio.opiqo.mpvoverssh.streaming.DefaultLocalMediaStreamController
...
class MpvOverSshApplication : Application() {
    ...
    @Suppress("unused")
    val localMediaStreamController by lazy { DefaultLocalMediaStreamController(this) }
}
